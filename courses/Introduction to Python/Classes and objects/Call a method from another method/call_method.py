class Calculator:
    ...
    def exponentiate(self, power):
        calculator = self.current # TODO: set the exponentiation `base`, it should be equal to the current value.
        for i in range(power - 1):
            self.multiply(calculator) # TODO: use the `multiply` method with the parameter `base` to calculate the result.
